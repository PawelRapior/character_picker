...
Stamina: 50
Strength: 50
Enter the character lottery to randomly select a new class.
Depending on the result, Monica transforms into one of the following:
Normal: No stat changes.
Warrior: HP +50, Stamina +30, Strength +40.
Mage: HP +30, Stamina +30, Strength +20.
Rogue: HP +20, Stamina +30, Strength +30.
